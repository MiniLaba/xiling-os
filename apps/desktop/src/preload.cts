...
const desktopApi = Object.freeze({
  researchKnowledge: (payload: Record<string, unknown>) => ipcRenderer.invoke("desktop:research-knowledge", payload) as Promise<import("./core/research-types.js").ResearchKnowledgeResult>,
