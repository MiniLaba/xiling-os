...
const english: Record<string, string> = {
  ...
  "常规": "General", "主题": "Appearance", "智能体": "Agents", "子智能体": "Subagents", "技能": "Skills", "连接": "Connections", "模型 API 连接": "Model connections", "文献服务": "Literature services", "科研数据账户": "Research data accounts", "汐灵设置": "Tide Mind settings", "界面主题": "Theme", "灵境": "Lingjing", "破晓": "Dawn", "语言": "Language", "界面语言": "Interface language", "进入工作区": "Enter workspace", "汐灵": "Tide Mind", "保存": "Save", "清除": "Clear", "测试连接": "Test connection", "刷新目录": "Refresh catalog", "关联能力": "Capabilities", "允许能力": "Allowed capabilities", "已安装": "installed",
};
